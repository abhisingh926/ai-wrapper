...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-6">
            ...
            <div className="absolute top-20 left-20 w-72 h-72 bg-indigo-500/10 rounded-full blur-[120px]" />
            <div className="absolute bottom-20 right-20 w-72 h-72 bg-cyan-500/10 rounded-full blur-[120px]" />

            <div className="w-full max-w-md relative z-10">
                {/* Logo */}
                <Link href="/" className="flex items-center justify-center gap-2 mb-10">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-400 flex items-center justify-center text-white font-bold text-xl">
                        A
                    </div>
                ...
                <div className="glass rounded-2xl p-10 text-center">
                    <h1 className="text-2xl font-bold text-white mb-2">Welcome to AIWrapper</h1>
                    <p className="text-slate-400 mb-10 text-sm">
                        Sign in to start building AI automations
                    </p>
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-xl
                            ...
                            hover:bg-gray-100 hover:shadow-lg hover:shadow-white/10
